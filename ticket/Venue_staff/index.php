...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $result = mysqli_query($conn, "SELECT * FROM venuestaff WHERE emailaddress = '$email'");
  if ($result) {
      ...
      if ($password == $data["password"]) {
        ...
        session_start();
          $_SESSION['id'] = $data["id"];
          echo $result? header("Location: view_staff.php"): "<Script>alert('Login Successful');</Script>";
          die();
      } else {
...
<body>
  <div class="logincard">
    ...
    <h1 class="title">eTicket</h1>
    <h4 class="title">Welcome to the Venue Staff panel</h4>
